...
export default function AdminTodayPage() {
  ...
  return (
    <div className="space-y-6">
      <PageHeader 
        title="Today&apos;s Usage" 
        description="All equipment usage for today across all users"
        action={
      ...
      <Card className="border-0 shadow-sm">
        <CardHeader>
          ...
          <CardDescription>Detailed breakdown of today&apos;s activity across all users</CardDescription>
        </CardHeader>
        <CardContent>
          {loading ? (
            ...
            <div className="text-center py-12">
              ...
              <p className="text-muted-foreground mb-4">
                No assemblies have been logged by any user today
              </p>
              <Link href="/admin/inventory">
                <Button>
                  <Plus className="h-4 w-4 mr-2" />
